...
public class MainActivity extends Cipherator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            new Passport(getApplicationContext(), "initPwd");
        } catch (Throwable e) {
            Log.e("pass", "failed", e);
        }
        ...
        findViewById(R.id.fab).setOnClickListener(view -> {
            ...
            findViewById(R.id.message_linear_layout).setVisibility(View.GONE);
...
//            v.setText(Base64.encodeToString(encrypted, 0 /* flags */));
        ...
        findViewById(R.id.message_linear_layout).setVisibility(View.VISIBLE);
